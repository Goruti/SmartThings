...
preferences {
        input("ip", "string", title:"IP Address", description: "192.168.2.68", defaultValue: "192.168.2.68" ,required: true, displayDuringSetup: true)
        input("port", "string", title:"Port", description: "5000", defaultValue: "5000" , required: true, displayDuringSetup: true)
